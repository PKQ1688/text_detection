...
def build_resnet_backbone(cfg, input_shape):
    ...
    if depth in [18, 34]:
        assert out_channels == 64, "Must set RESNETS.RES2_OUT_CHANNELS = 64 for R18/R34"
        assert not any(
            deform_on_per_stage
        ), "RESNETS.DEFORM_ON_PER_STAGE unsupported for R18/R34"
        assert res5_dilation == 1, "Must set RESNETS.RES5_DILATION = 1 for R18/R34"
        assert num_groups == 1, "Must set RESNETS.NUM_GROUPS = 1 for R18/R34"
